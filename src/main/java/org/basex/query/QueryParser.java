...
import org.basex.query.expr.ft.FTExtensionSelection;
import org.basex.query.expr.ft.FTMildNot;
import org.basex.query.expr.ft.FTNot;
import org.basex.query.expr.ft.FTOpts;
...
import static org.basex.query.QueryError.ANNVALUE;
import static org.basex.query.QueryError.ANNWHICH_X_X;
import static org.basex.query.QueryError.ARROWSPEC;
import static org.basex.query.QueryError.ATTDUPL_X;
import static org.basex.query.QueryError.AXISMISS_X;
import static org.basex.query.QueryError.BASX_ANNNUM_X_X_X;
import static org.basex.query.QueryError.BASX_ANNOT_X_X;
import static org.basex.query.QueryError.BASX_ANNTYPE_X_X_X;
import static org.basex.query.QueryError.BASX_OPTIONS_X;
import static org.basex.query.QueryError.BASX_TWICE_X_X;
import static org.basex.query.QueryError.BINDXMLURI_X_X;
import static org.basex.query.QueryError.BINDXML_X;
import static org.basex.query.QueryError.BXFT_MATCH;
import static org.basex.query.QueryError.CALCEXPR;
import static org.basex.query.QueryError.CASTUNKNOWN_X;
import static org.basex.query.QueryError.CITYPES_X_X;
import static org.basex.query.QueryError.CMPEXPR;
import static org.basex.query.QueryError.COMCLOSE;
import static org.basex.query.QueryError.COPYEXPR;
import static org.basex.query.QueryError.DECDUPL;
import static org.basex.query.QueryError.DECDUPLPROP_X;
import static org.basex.query.QueryError.DECITEM;
import static org.basex.query.QueryError.DECLINCOMPLETE;
import static org.basex.query.QueryError.DECLOPTION_X;
import static org.basex.query.QueryError.DUPLBASE;
import static org.basex.query.QueryError.DUPLBOUND;
import static org.basex.query.QueryError.DUPLCOLL;
import static org.basex.query.QueryError.DUPLCONS;
import static org.basex.query.QueryError.DUPLCOPYNS;
import static org.basex.query.QueryError.DUPLITEM;
import static org.basex.query.QueryError.DUPLMODULE_X;
import static org.basex.query.QueryError.DUPLNS;
import static org.basex.query.QueryError.DUPLNSDECL_X;
import static org.basex.query.QueryError.DUPLNSDEF_X;
import static org.basex.query.QueryError.DUPLORD;
import static org.basex.query.QueryError.DUPLORDEMP;
import static org.basex.query.QueryError.DUPLREVAL;
import static org.basex.query.QueryError.DUPLVAR_X;
import static org.basex.query.QueryError.ELEMNAME_X;
import static org.basex.query.QueryError.EVALUNARY;
import static org.basex.query.QueryError.EXPREMPTY;
import static org.basex.query.QueryError.FLWORCOLL_X;
import static org.basex.query.QueryError.FLWORRETURN;
import static org.basex.query.QueryError.FTDUP_X;
import static org.basex.query.QueryError.FTIGNORE;
import static org.basex.query.QueryError.FTMATCH_X;
import static org.basex.query.QueryError.FTNOSTEM_X;
import static org.basex.query.QueryError.FTNOTOK_X;
import static org.basex.query.QueryError.FTRANGE;
import static org.basex.query.QueryError.FTSTOP;
import static org.basex.query.QueryError.FUNCDUPL_X;
import static org.basex.query.QueryError.FUNCMISS_X;
import static org.basex.query.QueryError.FUNCNAME;
import static org.basex.query.QueryError.FUNCUNKNOWN_X;
import static org.basex.query.QueryError.GRPBY;
import static org.basex.query.QueryError.GVARNOTDEFINED_X;
import static org.basex.query.QueryError.IFPAR;
import static org.basex.query.QueryError.IMPLSCHEMA;
import static org.basex.query.QueryError.IMPLVAL;
import static org.basex.query.QueryError.INCOMPLETE;
import static org.basex.query.QueryError.INTEXP;
import static org.basex.query.QueryError.INVALPI;
import static org.basex.query.QueryError.INVCHARREF_X;
import static org.basex.query.QueryError.INVENTITY_X;
import static org.basex.query.QueryError.INVISIBLE;
import static org.basex.query.QueryError.INVMAPKEY;
import static org.basex.query.QueryError.INVMAPVAL;
import static org.basex.query.QueryError.INVNCNAME_X;
import static org.basex.query.QueryError.INVURI_X;
import static org.basex.query.QueryError.KEYSPEC;
import static org.basex.query.QueryError.MAINMOD;
import static org.basex.query.QueryError.MAPTAAT_X;
import static org.basex.query.QueryError.MODEXPR;
import static org.basex.query.QueryError.MODOUT;
import static org.basex.query.QueryError.MODULENS_X;
import static org.basex.query.QueryError.NOANN;
import static org.basex.query.QueryError.NOATTNAME;
import static org.basex.query.QueryError.NOCATCH;
import static org.basex.query.QueryError.NOCLOSING_X;
import static org.basex.query.QueryError.NOCOMCONS;
import static org.basex.query.QueryError.NOCOUNT;
import static org.basex.query.QueryError.NODECLFORM_X;
import static org.basex.query.QueryError.NODOCCONS;
import static org.basex.query.QueryError.NOELEMNAME;
import static org.basex.query.QueryError.NOENCLEXPR;
import static org.basex.query.QueryError.NOEXPR;
import static org.basex.query.QueryError.NOFOR;
import static org.basex.query.QueryError.NOFTSELECT_X;
import static org.basex.query.QueryError.NOFUNBODY;
import static org.basex.query.QueryError.NOIF;
import static org.basex.query.QueryError.NOLET;
import static org.basex.query.QueryError.NONAME_X;
import static org.basex.query.QueryError.NOPRAGMA;
import static org.basex.query.QueryError.NOQUOTE_X;
import static org.basex.query.QueryError.NORETURN;
import static org.basex.query.QueryError.NOREVAL;
import static org.basex.query.QueryError.NOSOME;
import static org.basex.query.QueryError.NOSTOPFILE_X;
import static org.basex.query.QueryError.NOSWITCH;
import static org.basex.query.QueryError.NOTXTCONS;
import static org.basex.query.QueryError.NOTYPESWITCH;
import static org.basex.query.QueryError.NOURI_X;
import static org.basex.query.QueryError.NOVALIDATE;
import static org.basex.query.QueryError.NOVARDECL;
import static org.basex.query.QueryError.NOVARNAME;
import static org.basex.query.QueryError.NOWHERE;
import static org.basex.query.QueryError.NOWINDOW;
import static org.basex.query.QueryError.NSAXIS;
import static org.basex.query.QueryError.NSCONS;
import static org.basex.query.QueryError.NSEMPTY;
import static org.basex.query.QueryError.NSEMPTYURI;
import static org.basex.query.QueryError.NSMISS_X;
import static org.basex.query.QueryError.NSMODURI;
import static org.basex.query.QueryError.NSWRONG;
import static org.basex.query.QueryError.NUMBERDBL_X;
import static org.basex.query.QueryError.NUMBERDEC_X;
import static org.basex.query.QueryError.NUMBERITR;
import static org.basex.query.QueryError.NUMBERWS;
import static org.basex.query.QueryError.ORDERBY;
import static org.basex.query.QueryError.OUTDUPL_X;
import static org.basex.query.QueryError.PIWRONG;
import static org.basex.query.QueryError.PIXML_X;
import static org.basex.query.QueryError.PRAGMAINV;
import static org.basex.query.QueryError.PREDMISSING;
import static org.basex.query.QueryError.PROLOGORDER;
import static org.basex.query.QueryError.QNAME_X;
import static org.basex.query.QueryError.QUERYEMPTY;
import static org.basex.query.QueryError.QUERYEND_X;
import static org.basex.query.QueryError.QUERYINV_X;
import static org.basex.query.QueryError.RANGE_X;
import static org.basex.query.QueryError.RESERVED_X;
import static org.basex.query.QueryError.SCHEMAINV_X;
import static org.basex.query.QueryError.SIMPLETYPE_X;
import static org.basex.query.QueryError.STEPMISS_X;
import static org.basex.query.QueryError.TAGWRONG_X_X;
import static org.basex.query.QueryError.TYPE30_X;
import static org.basex.query.QueryError.TYPEINVALID;
import static org.basex.query.QueryError.TYPEPAR;
import static org.basex.query.QueryError.TYPEUNDEF_X;
import static org.basex.query.QueryError.TYPEUNKNOWN_X;
import static org.basex.query.QueryError.UPCTX;
import static org.basex.query.QueryError.UPDATINGVAR;
import static org.basex.query.QueryError.VARFUNC;
import static org.basex.query.QueryError.VARUNDEF_X;
import static org.basex.query.QueryError.WHICHDEFCOLL_X;
import static org.basex.query.QueryError.WHICHMODFILE_X;
import static org.basex.query.QueryError.WHICHMODULE_X;
import static org.basex.query.QueryError.WHICHTYPE_X;
import static org.basex.query.QueryError.WRONGCHAR_X_X;
import static org.basex.query.QueryError.WRONGMODULE_X_X;
import static org.basex.query.QueryError.XMLNSDEF_X;
import static org.basex.query.QueryError.XQUERYENC2_X;
import static org.basex.query.QueryError.XQUERYVER_X;
import static org.basex.query.QueryError.chop;
import static org.basex.query.QueryText.AFTER;
import static org.basex.query.QueryText.ALL;
import static org.basex.query.QueryText.ALLOWING;
import static org.basex.query.QueryText.AND;
import static org.basex.query.QueryText.ANY;
import static org.basex.query.QueryText.ARRAY;
import static org.basex.query.QueryText.ARRAYSTR;
import static org.basex.query.QueryText.ARROW;
import static org.basex.query.QueryText.AS;
import static org.basex.query.QueryText.ASCENDING;
import static org.basex.query.QueryText.ASSIGN;
import static org.basex.query.QueryText.ASTERISK;
import static org.basex.query.QueryText.AT;
import static org.basex.query.QueryText.ATTRIBUTE;
import static org.basex.query.QueryText.BASEX_PREFIX;
import static org.basex.query.QueryText.BASE_URI;
import static org.basex.query.QueryText.BEFORE;
import static org.basex.query.QueryText.BOUNDARY_SPACE;
import static org.basex.query.QueryText.BY;
...
import static org.basex.query.QueryText.CATCH;
import static org.basex.query.QueryText.CDATA;
import static org.basex.query.QueryText.COL;
import static org.basex.query.QueryText.COLLATION;
import static org.basex.query.QueryText.COLS;
import static org.basex.query.QueryText.COMMA;
import static org.basex.query.QueryText.COMMENT;
import static org.basex.query.QueryText.CONCAT;
...
import static org.basex.query.QueryText.CONTEXT;
import static org.basex.query.QueryText.COPY;
import static org.basex.query.QueryText.COPY_NAMESPACES;
import static org.basex.query.QueryText.COUNT;
import static org.basex.query.QueryText.CURLY1;
import static org.basex.query.QueryText.CURLY2;
import static org.basex.query.QueryText.DB_PREFIX;
import static org.basex.query.QueryText.DB_URI;
import static org.basex.query.QueryText.DECFORMATS;
import static org.basex.query.QueryText.DECIMAL_FORMAT;
...
import static org.basex.query.QueryText.DESCENDING;
import static org.basex.query.QueryText.DIACRITICS;
import static org.basex.query.QueryText.DIFFERENT;
import static org.basex.query.QueryText.DISTANCE;
import static org.basex.query.QueryText.DIV;
import static org.basex.query.QueryText.DOCUMENT;
import static org.basex.query.QueryText.DOLLAR;
import static org.basex.query.QueryText.DOT2;
import static org.basex.query.QueryText.ELEMENT;
import static org.basex.query.QueryText.ELSE;
import static org.basex.query.QueryText.EMPTYORD;
import static org.basex.query.QueryText.EMPTY_SEQUENCE;
import static org.basex.query.QueryText.ENCODING;
import static org.basex.query.QueryText.END;
import static org.basex.query.QueryText.ENTIRE;
import static org.basex.query.QueryText.EQNAME;
import static org.basex.query.QueryText.ERROR_URI;
import static org.basex.query.QueryText.EVERY;
import static org.basex.query.QueryText.EXACTLY;
import static org.basex.query.QueryText.EXCEPT;
import static org.basex.query.QueryText.EXCL;
import static org.basex.query.QueryText.EXTERNAL;
import static org.basex.query.QueryText.FIRST;
import static org.basex.query.QueryText.FOR;
import static org.basex.query.QueryText.FROM;
import static org.basex.query.QueryText.FTAND;
import static org.basex.query.QueryText.FTNOT;
import static org.basex.query.QueryText.FTOR;
import static org.basex.query.QueryText.FT_OPTION;
...
import static org.basex.query.QueryText.GROUP;
import static org.basex.query.QueryText.IDIV;
import static org.basex.query.QueryText.IF;
import static org.basex.query.QueryText.IMPORT;
import static org.basex.query.QueryText.IN;
import static org.basex.query.QueryText.INHERIT;
import static org.basex.query.QueryText.INSENSITIVE;
import static org.basex.query.QueryText.INSERT;
import static org.basex.query.QueryText.INSTANCE;
import static org.basex.query.QueryText.INTERSECT;
import static org.basex.query.QueryText.INTO;
import static org.basex.query.QueryText.IS;
import static org.basex.query.QueryText.ITEMM;
import static org.basex.query.QueryText.LANGUAGE;
import static org.basex.query.QueryText.LAST;
import static org.basex.query.QueryText.LAX;
import static org.basex.query.QueryText.LEAST;
import static org.basex.query.QueryText.LET;
import static org.basex.query.QueryText.LEVELS;
import static org.basex.query.QueryText.LOCAL_URI;
import static org.basex.query.QueryText.LOWERCASE;
import static org.basex.query.QueryText.MAP;
import static org.basex.query.QueryText.MAPSTR;
import static org.basex.query.QueryText.MOD;
import static org.basex.query.QueryText.MODIFY;
import static org.basex.query.QueryText.MODULE;
import static org.basex.query.QueryText.MOST;
import static org.basex.query.QueryText.NEXT;
import static org.basex.query.QueryText.NO;
import static org.basex.query.QueryText.NODE;
import static org.basex.query.QueryText.NODES;
import static org.basex.query.QueryText.NOT;
import static org.basex.query.QueryText.NO_INHERIT;
import static org.basex.query.QueryText.NO_PRESERVE;
import static org.basex.query.QueryText.NSPACE;
import static org.basex.query.QueryText.OCCURS;
import static org.basex.query.QueryText.OF;
import static org.basex.query.QueryText.ONLY;
import static org.basex.query.QueryText.OPTION;
import static org.basex.query.QueryText.OR;
import static org.basex.query.QueryText.ORDER;
...
import static org.basex.query.QueryText.PARAGRAPH;
import static org.basex.query.QueryText.PARAGRAPHS;
...
import static org.basex.query.QueryText.PI;
import static org.basex.query.QueryText.PIPE;
import static org.basex.query.QueryText.PRAGMA;
import static org.basex.query.QueryText.PRESERVE;
import static org.basex.query.QueryText.PREVIOUS;
import static org.basex.query.QueryText.QUERY_URI;
import static org.basex.query.QueryText.QUESTION;
import static org.basex.query.QueryText.READ_LOCK;
import static org.basex.query.QueryText.RELATIONSHIP;
...
import static org.basex.query.QueryText.REVALIDATION;
import static org.basex.query.QueryText.SAME;
import static org.basex.query.QueryText.SATISFIES;
import static org.basex.query.QueryText.SCHEMA;
import static org.basex.query.QueryText.SCHEMA_ATTRIBUTE;
import static org.basex.query.QueryText.SCHEMA_ELEMENT;
import static org.basex.query.QueryText.SCORE;
import static org.basex.query.QueryText.SENSITIVE;
import static org.basex.query.QueryText.SENTENCE;
import static org.basex.query.QueryText.SENTENCES;
import static org.basex.query.QueryText.SKIP;
import static org.basex.query.QueryText.SLIDING;
import static org.basex.query.QueryText.SOME;
import static org.basex.query.QueryText.SQUARE1;
import static org.basex.query.QueryText.SQUARE2;
import static org.basex.query.QueryText.STABLE;
import static org.basex.query.QueryText.START;
import static org.basex.query.QueryText.STEMMING;
import static org.basex.query.QueryText.STOP;
import static org.basex.query.QueryText.STRICT;
import static org.basex.query.QueryText.STRIP;
import static org.basex.query.QueryText.SWITCH;
import static org.basex.query.QueryText.TEXT;
import static org.basex.query.QueryText.THEN;
...
import static org.basex.query.QueryText.TREAT;
import static org.basex.query.QueryText.TRY;
import static org.basex.query.QueryText.TUMBLING;
import static org.basex.query.QueryText.TYPE;
import static org.basex.query.QueryText.TYPESWITCH;
import static org.basex.query.QueryText.UNION;
import static org.basex.query.QueryText.UNORDERED;
import static org.basex.query.QueryText.UPDATE;
import static org.basex.query.QueryText.UPDATING;
import static org.basex.query.QueryText.UPPERCASE;
import static org.basex.query.QueryText.USING;
import static org.basex.query.QueryText.VALIDATE;
import static org.basex.query.QueryText.VALUEE;
import static org.basex.query.QueryText.VARIABLE;
import static org.basex.query.QueryText.VERSION;
import static org.basex.query.QueryText.WEIGHT;
import static org.basex.query.QueryText.WHEN;
import static org.basex.query.QueryText.WHERE;
import static org.basex.query.QueryText.WILDCARDS;
import static org.basex.query.QueryText.WINDOW;
import static org.basex.query.QueryText.WITH;
import static org.basex.query.QueryText.WITHOUT;
import static org.basex.query.QueryText.WORD;
import static org.basex.query.QueryText.WORDS;
import static org.basex.query.QueryText.WRITE_LOCK;
import static org.basex.query.QueryText.XMLNS_URI;
import static org.basex.query.QueryText.XML_URI;
import static org.basex.query.QueryText.XQ10;
import static org.basex.query.QueryText.XQ11;
import static org.basex.query.QueryText.XQ30;
import static org.basex.query.QueryText.XQ31;
import static org.basex.query.QueryText.XQUERY;
import static org.basex.query.QueryText.XQ_URI;
import static org.basex.util.Token.COLON;
...
public class QueryParser extends InputParser {
  ...
  public void module(final byte[] path, final byte[] uri) throws QueryException {
    // get absolute path
    final IO io = sc.resolve(qc.options.get(MainOptions.MODPATH) + "/" + string(path), string(uri));
    final byte[] p = token(io.path());

    // check if module has already been parsed
    final byte[] u = qc.modParsed.get(p);
    if(u != null) {
      if(!eq(uri, u)) throw error(WRONGMODULE_X_X, uri, io.path());
      return;
    }
    ...
    try {
      ...
      throw error(WHICHMODFILE_X, io.path());
    }
  ...
  private Pragma[] pragma() throws QueryException {
    ...
    do {
      ...
      if(eq(name.prefix(), DB_PREFIX)) {
        ...
        final Option<?> opt = qc.options.option(key);
  ...
  private void ftThesaurusID(final ThesQuery thes) throws QueryException {
    ...
    thes.add(new Thesaurus(fl, rel, min, max, qc.options));
  }
